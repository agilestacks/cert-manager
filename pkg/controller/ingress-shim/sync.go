...
func (c *Controller) Sync(ctx context.Context, ing *extv1beta1.Ingress) error {
		...
		glog.Infof("Not syncing ingress %s/%s as it does not contain necessary annotations and requireAnnotations is %t and issuerName is %s", ing.Namespace, ing.Name, c.defaults.requireAnnotations, c.defaults.issuerName)
		return nil
	}
